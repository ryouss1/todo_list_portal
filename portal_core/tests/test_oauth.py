...
from portal_core.core.auth.oauth.github import GitHubProviderConfig
from portal_core.core.auth.oauth.google import GoogleProviderConfig
from portal_core.core.auth.oauth.provider import get_provider_config
...
class TestOAuthFlow:
    ...
    @patch("portal_core.services.oauth_service.exchange_code_for_token")
    @patch("portal_core.services.oauth_service.fetch_userinfo")
...
class TestOAuthLinking:
    ...
    def test_unlink_last_auth_method_rejected(self, core_app, db_session):
        ...
        core_app.dependency_overrides[get_current_user_id] = lambda: 70
