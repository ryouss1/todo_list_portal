...
| `portal_core/tests/test_groups.py` | Group API（CRUD + RBAC） | 11件 |
| `portal_core/tests/test_websocket.py` | WebSocket（認証 + 並行ブロードキャスト競合） | 6件 |
...
| `tests/test_presence.py` | Presence API（Backlogチケット + アクティブタスク上限） | 18件 |
